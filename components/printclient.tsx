    ...
    const downloadPdf = () => {
      if (receiptRef.current) {
        ...
        const opt = {
          ...
          filename: `CargoLog-Receipt-${packageData.tracking_number}.pdf`,
        ...
        <div ref={receiptRef} className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="border-t border-b py-4 mb-6">
            <div className="text-center">
              <h2 className="text-2xl font-bold">Cargo Logistics</h2>
          ...
          <div className="text-center text-sm text-muted-foreground mt-12 pt-4 border-t">
            <p>Thank you for choosing Cargo Logistics for your shipping needs.</p>
            <p>For any inquiries, please contact support@cargo-log.pro</p>
          </div>

          <div className="mt-8 text-center">
            <div className="inline-block border-t border-dashed w-full pt-2 text-xs text-muted-foreground">
              <p>This is an official receipt from Cargo Logistics</p>
              <p>Document generated on {new Date().toUTCString()}</p>
            </div>
          </div>
        </div>
      </div>
