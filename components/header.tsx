...
import { Car, Menu, Search, Moon, Sun, Laptop, Settings, Zap, Battery } from "lucide-react"
...
export default function Header() {
  ...
  const navItems = [
    ...
    { href: "#about", label: "Fleet" },
    { href: "#shipping", label: "Schedule" },
          ...
          <Link href="/" className="flex items-start">
            <div className="h-10 w-auto flex items-center justify-center relative">
              <svg width="200" height="30" viewBox="0 0 200 30" xmlns="http://www.w3.org/2000/svg">
                ...
                <text x="5" y="22">TESLA DELIVERY</text>
              </svg>
            </div>
          </Link>
        </div>
